...
.bgc-w {
	...
	<div class="row" style="padding-top: 10px;">
		<div class="col-md-2">
			<h1 style="font-size: 24px; margin: 0;" class="">定常更新</h1>
		</div>
		<div class="col-md-10 text-right">
			<a href="index"><span class="glyphicon glyphicon-home"></span> 首页</a> >
			<a disabled="disabled">定常更新</a>
		</div>
	</div>
		...
		<div class="col-md-12">
			...
			<div class="bgc-w box box-primary">
				...
				<div class="box-header">
					<h3 class="box-title">
						<a href="kanbanedit" class="label label-success" style="padding: 5px;">
